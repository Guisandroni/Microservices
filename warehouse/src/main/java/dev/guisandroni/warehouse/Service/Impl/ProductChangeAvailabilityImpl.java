...
@Service
public class ProductChangeAvailability implements dev.guisandroni.warehouse.Service.ProductChangeAvailability {

    private final RabbitTemplate rabbitTemplate;
    private final String exchangeName;
    private final String routingKey;

    public ProductChangeAvailability(RabbitTemplate rabbitTemplate,
